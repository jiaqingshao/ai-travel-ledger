...
| 📋 待启动 | 3 | 025 (Google Play), 026-焦点跳转 (V1.1.1) |
| ⏳ 进行中 | 0 | — |
| 🆕 **⏸️ V1.1 Backlog** | **3** | **031 (E-008 语音), 032 (E-009 重复), 033 (E-010 统计) — ADR-004 决策** |

**总 ISSUE 数**: 27 个实体条目 (013~033, 不含中间代码 # 标识或重复条目)
...
- **决策文档**: [ADR-004](../02-architecture/04-adr/ADR-004-prd-v0.3-p0-defer.md) — PRD v0.3 P0 暂缓决策
...
*本文件最后同步: 2026-07-15 (ADR-004 决策同步)*
